...
function manageSug(interaction, options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (button.isButton()) {
            try {
                options.deny = {
                    color: ((_a = options === null || options === void 0 ? void 0 : options.deny) === null || _a === void 0 ? void 0 : _a.color) || (0, discord_js_1.colorResolvable)('RED')
                };
                options.accept = {
                ...
                function calc(oldemb, msg) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        discord_js_1.ButtonBuilder.from(msg.components[0].components[0]).setLabel =
                            lik.toString();
                        discord_js_1.ButtonBuilder.from(msg.components[0].components[1]).setLabel =
                            dislik.toString();
                        oldemb = discord_js_1.ButtonBuilder.from(oldemb);
                ...
                function dec(reason, oldemb, msg, user) {
                    var _a;
                    return __awaiter(this, void 0, void 0, function* () {
                        oldemb = discord_js_1.EmbedBuilder.from(oldemb);
                        oldemb.fields[0].value = `Declined\n\n**Reason:** \`${reason}\``;
                        oldemb.setColor(((_a = options === null || options === void 0 ? void 0 : options.deny) === null || _a === void 0 ? void 0 : _a.color) || (0, discord_js_1.colorResolvable)('RED'));
                        oldemb.setFooter({ text: `Declined by ${user.tag}` });
                        discord_js_1.ButtonBuilder.from[msg.components[0].components[0]].setDisabled = true;
                        discord_js_1.ButtonBuilder.from(msg.components[0].components[1]).setDisabled = true;
                        button.message.edit({
                            embeds: [oldemb],
                            components: msg.components
                        });
