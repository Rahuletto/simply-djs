            ...
            try {
                ...
                function calc(oldemb, msg) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        lik1[0].components[0] = discord_js_1.ButtonBuilder.from(lik[0].components[0]).setLabel =
                            lik.toString();
                        lik1[0].components[1] = discord_js_1.ButtonBuilder.from(lik1[0].components[1]).setLabel =
                            dislik.toString();
                ...
                function dec(reason, oldemb, msg, user) {
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        msgs[0].components[0] = discord_js_1.ButtonBuilder.from[msgs[0].components[0]].setDisabled = true;
                        msgs[0].components[1] = discord_js_1.ButtonBuilder.from(msgs[0].components[1]).setDisabled = true;
                        button.message.edit({
                            embeds: [oldemb],
                            components: msgs
                        });
