...
function calculator(interaction, options = {
    buttons: { numbers: discord_js_1.ButtonStyle.Success, symbols: discord_js_1.ButtonStyle.Primary, delete: discord_js_1.ButtonStyle.Danger }
}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            options.buttons = {
                numbers: ((_a = options.buttons) === null || _a === void 0 ? void 0 : _a.numbers) || (0, convStyle_1.convStyle)('SECONDARY'),
                symbols: ((_b = options.buttons) === null || _b === void 0 ? void 0 : _b.symbols) || (0, convStyle_1.convStyle)('PRIMARY'),
                delete: ((_c = options.buttons) === null || _c === void 0 ? void 0 : _c.delete) || (0, convStyle_1.convStyle)('DANGER')
            };
            let message;
