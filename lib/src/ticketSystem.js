...
function ticketSystem(message, options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log((0, convStyle_1.convStyle)(options.button.style));
            const ticketbtn = new discord_js_1.ButtonBuilder()
                .setStyle((0, convStyle_1.convStyle)((_a = options === null || options === void 0 ? void 0 : options.button) === null || _a === void 0 ? void 0 : _a.style) || discord_js_1.ButtonStyle.Primary)
